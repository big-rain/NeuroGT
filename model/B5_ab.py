...
class TransGraph(nn.Module):
    def __init__(self,
        ...
        self.pos_node_emb = Linear(3, channels)


        self.fea_lin = Linear(9, 64)
...
if __name__ == '__main__':
    ...
    from dataloader.LAPE import RobustLaplacianEigenPE
    from dataloader.HKPE import AddHeatKernelPE_v2, AddHeatKernelPE_v3
    ...
    pre_transform = T.Compose([
        ...
        RobustLaplacianEigenPE(k=20, attr_name='pe'),
        T.AddRandomWalkPE(walk_length=20, attr_name='pe'),
        # AddHeatKernelPE_v3(time=[0.1, 1.0, 10.0], diag_attr_name='hk_pe',
        #                    full_attr_name='bias'),
    ...
    # pretrained_weights = torch.load('../ckgs/ablation/act_layer/act_layer_hkpe_0.6263_0.6127.pt')
    ...
    scheduler = cosine_with_warmup_scheduler(optimizer, num_warmup_epochs=50, max_epoch=500)
    ...
    for epoch in range(1, 250):
        ...
        if val_acc > max_acc:
            ...
            torch.save(model.state_dict(),
                       osp.join('../ckgs/ablation/n7/', 'n7_lape_{:.4f}_{:.4f}.pt'.format(max_acc, val_avg_acc)))
        print(
